...
class Transformer:
    ...
    def apply_transformations(self, column_mappings):
        ...
        for mapping in column_mappings:
            ...
            logger.info(f"Applying transformation for column: {target_column}")
            ...
            if method is None:
                logger.error(f"Unsupported transformation type: {transform_type}")
            ...
            logger.info(f"Transformation applied for {target_column}")
    ...
    def transform_generate_id(self, source_column, target_column, transformation):
        ...
        logger.info(f"Generating UUID for {target_column}")
    ...
    def transform_lookup(self, source_column, target_column, transformation):
        ...
        logger.info(f"Performing lookup transformation for {target_column}")
    ...
    def transform_normalize_date(self, source_column, target_column, transformation):
        ...
        logger.info(f"Normalizing date values for {target_column}")
    ...
    def transform_aggregate(self, source_column, target_column, transformation):
        ...
        logger.info(f"Applying aggregation for {target_column}")
    ...
    def transform_conditional_map(self, source_column, target_column, transformation):
        ...
        logger.info(f"Applying conditional map for {target_column}")
    ...
    def transform_derive(self, source_column, target_column, transformation):
        ...
        logger.info(f"Calculating derived values for {target_column}")
    ...
    def transform_split_date(self, source_column, target_column, transformation):
        ...
        logger.info(f"Splitting date values for {target_column}")
